...
import cv2
from ImageAI.CatDog.dataset import DataSet
...
images, labels, ids, cls = load_train('testing_data', 128, ['cats', 'dogs'])
...
#
#
# def read_train_sets(train_path, image_size, classes, validation_size=0.2):
...
# test_images, test_ids = read_test_set(test_path, img_size, classes)
#
# print("Size of:")
